export const ar = {
    ...
    'about_p1': 'أنا خريج تقنية معلومات من <strong>جامعة الإمام محمد بن سعود الإسلامية</strong> (معدل 4.16)، أعمل بشكل أساسي على <strong>Unity</strong> و <strong>C#</strong>، ومعي <strong>Blender</strong> للنمذجة ثلاثية الأبعاد. طوّرت وأصدرت عدة ألعاب ثلاثية الأبعاد — منها <strong>The Hidden Kanz</strong> و <strong>The Scary Library</strong> — يمكن للاعبين تحميلها واللعب بها فعلًا.',
    'about_p2': 'تركيزي على أنظمة اللعب: الميكانيكيات، وسلوك الأعداء، والتدرّج الذي يحدد شعور اللعبة فعلًا. أستمتع بأخذ فكرة خام ودفعها حتى تتحول إلى شيء يعمل وممتع فعلًا.',
    'about_p3': 'إلى جانب الألعاب، بنيت تطبيقات ويب وأدوات ذكاء اصطناعي، لذا أرتاح مع منطق الخوادم وقواعد البيانات وواجهات البرمجة حينما يتطلب المشروع ذلك. كما طوّرت ألعابًا ضمن فريق، وأكون في أفضل حالاتي عند صنع أنظمة تبدو سلسة ومتجاوبة وممتعة للعب.',
