...
export const ar = {
    ...
    projects: {
        ...
        'iwjats': [
            { type: 'video', id: '1_v0l9b5qmU', title: 'العرض الترويجي للعبة', desc: 'شاهد العرض الترويجي الكامل — عمل صيانة روتينية في المنشأة النووية، على بعد مسمار واحد مرتخٍ من الكارثة الكاملة.' },
