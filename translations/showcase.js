...
export const en = {
    ...
    projects: {
        ...
        'masarflow': [
            { src: 'images/Projects/MasarFlow/screenshot1.webp', title: 'MasarFlow Launcher', desc: 'The desktop launcher verifying local requirements — project files, version, Node.js, pnpm, and Python — before running MasarFlow on your machine.' },
            { src: 'images/Projects/MasarFlow/screenshot2.webp', title: 'Workspace Dashboard', desc: 'Project overview showing health, architecture, and tech-debt scores alongside active work, specs in flight, recent notes, and activity feeds.' },
            { src: 'images/Projects/MasarFlow/screenshot3.webp', title: 'Task Boards', desc: 'Kanban board with Backlog, To do, In progress, Review, and Done columns for tracking sprint tasks linked to specs.' },
            { src: 'images/Projects/MasarFlow/screenshot4.webp', title: 'Knowledge Graph', desc: 'Interactive graph linking notes, specs, tasks, systems, and commits so you can explore how everything in the workspace connects.' },
            { src: 'images/Projects/MasarFlow/screenshot5.webp', title: 'AI Assistant Chat', desc: 'Agentic chat where the assistant reads the workspace and carries out actions — here creating a note in the Brain on request.' },
            { src: 'images/Projects/MasarFlow/screenshot6.webp', title: 'Notes Editor', desc: 'Notes with folders, tags, write/read modes, and linked mentions — here showing a Five Famous Quotes note.' },
        ],
    },
    videos: {},
};
...
export const ar = {
    ...
    projects: {
        ...
        'masarflow': [
            { src: 'images/Projects/MasarFlow/screenshot1.webp', title: 'لانشر مسار فلو', desc: 'اللانشر يفحص المتطلبات على جهازك — ملفات المشروع والإصدار وNode.js وpnpm وPython — قبل ما يشغّل مسار فلو.' },
            { src: 'images/Projects/MasarFlow/screenshot2.webp', title: 'لوحة المشروع', desc: 'نظرة عامة على المشروع فيها درجات الصحة والهيكل والديون التقنية، مع الشغل الحالي والمواصفات وملاحظات الأنشطة.' },
            { src: 'images/Projects/MasarFlow/screenshot3.webp', title: 'لوحات المهام', desc: 'كانبان فيه أعمدة: مؤجلة، بنسويه، شغالين عليه، مراجعة، وخلصان — عشان تتابع مهام السبرنت المرتبطة بالمواصفات.' },
            { src: 'images/Projects/MasarFlow/screenshot4.webp', title: 'خريطة المعرفة', desc: 'جراف تفاعلي يربط الملاحظات والمواصفات والمهام والأنظمة والكوميتات، عشان تشوف كيف كل شي في المساحة متصل.' },
            { src: 'images/Projects/MasarFlow/screenshot5.webp', title: 'شات المساعد الذكي', desc: 'شات يقرأ محتوى المساحة وينفّذ أوامرك — هنا يسوي ملاحظة في المخدة (Brain) لما تطلب.' },
            { src: 'images/Projects/MasarFlow/screenshot6.webp', title: 'محرر الملاحظات', desc: 'ملاحظات مع مجلدات ووسوم وأوضاع قراءة وكتابة وروابط — هنا معروض فيها ملاحظة خمس اقتباسات مشهورة.' },
        ],
    },
    videos: {},
};
